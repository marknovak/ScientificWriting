...
Come to class ready to share a draft of your Introduction (whatever its state).

## Activity

Get into groups of three.  Take 5-10 minutes to read the drafts of your peers' introductions. For each of your two peers, take 15 minute to write answers to the following questions.
...
4. Was the logical flow of the argument clear?  Summarize the logic in 4-8 words (e.g., x -> y -> z).  Was there a part of the argument that could be clarified?

5. If the Introduction ended with the “take-home” message, what was it?  Paraphrase it in 1-3 sentences, being as specific as you think the author was intending it to be.  Did it address what you were expecting it to address based on the rest of the Introduction?

After everyone is finished (_35-40 minutes_), take up to 10 minutes to explain your answers to each of your peers.  (_This will take another 30 minutes combined._)

...
\begin{frame}{Rejection Management}
  ...
  Rejection sucks.  
  Get over it and aim to submit a rejected manuscript elsewhere quickly ($<$ 4--6 weeks). 
...
\begin{frame}{Revision \& Resubmission Workflow}
  ...
  \begin{itemize}
    ...
    \item Track changes in manuscript (or use \LaTeX\ diff tool)
...
\begin{frame}{Peer Review History}
  ...
  \begin{itemize}
    \item What stood out in the reviewers' comments?
    \item What stood out in the editor's decision letters?
    \item What did the authors do well in their responses?

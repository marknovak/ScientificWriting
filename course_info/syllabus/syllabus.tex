...
\noindent
See
\href{https://github.com/marknovak/ScientificWriting}{https://github.com/marknovak/ScientificWriting}.
...
F = 0--60 \%.
	...
	\begin{tabular}{p{0.22\textwidth} p{0.73\textwidth}}
		...
		Needs Improvement &
		Incomplete, unclear, poorly revised, or misaligned with expectations. \\
		\bottomrule
	\end{tabular}
	...
	\begin{tabular}{p{0.5\textwidth} p{0.15\textwidth} p{0.3\textwidth}}
		...
		Peer Review \& Collaboration & 15\% & Feedback and ethics \\
